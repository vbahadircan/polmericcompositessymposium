  ...
  const content = {
    en: {
      ...
      keyDates: [
        ...
        { event: "Submission of Full Proceedings", date: "01.09.2025" },
    ...
    tr: {
      ...
      keyDates: [
        { event: "Özet Başvuruları", date: "06.06.2025" },
        { event: "Erken Kayıt Son Tarihi", date: "28.07.2025" },
        { event: "Kabul Edilen Bildirilerin Duyurulması", date: "01.07.2025" },
        { event: "Tam Metin Bildirilerin Sunulması", date: "01.09.2025" },
        { event: "Sponsorluk ve Reklam Başvuruları Son Tarihi", date: "15.09.2025" },
        { event: "Çalıştay Başvuruları Son Tarihi", date: "01.09.2025" },
      ]
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-end mb-4">
          <button
            ...
            className="bg-white text-gray-800 px-4 py-2 rounded-lg font-medium hover:bg-gray-50 transition-all duration-200 shadow-md"
          >
            {language === 'en' ? 'TR' : 'EN'}
          </button>
        </div>

        <h2 className="text-3xl font-semibold text-gray-900 mb-8 text-center">{currentContent.title}</h2>
        <div className="relative flex flex-col items-center">
          ...
          <div className="space-y-12 w-full">
            {currentContent.keyDates.map((item, index) => (
