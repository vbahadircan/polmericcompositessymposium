...
export default function Committee() {
  ...
  const organizingCommittee = [
    ...
    { name: "Assoc. Prof. Dr. Levent Aydın", title: "Izmir Katip Çelebi University" },
    { name: "Şekip Avdagiç", title: "Istanbul Chamber of Commerce (ITO), President" },
...
const scientificAdvisoryCommittee = [
  ...
  { name: "Prof. Dr. Metin Tanoğlu", title: "Izmir Institute of Technology (IYTE)" },
  ...
  { name: "Assoc. Prof. Dr. Elif Alyamaç Seydibeyoğlu", title: "Ege University" },
  { name: "Prof. Dr. Cevdet Kaynak", title: "Middle East Technical University (METU)" },
  { name: "Prof. Dr. Ülkü Yılmazer", title: "Middle East Technical University (METU)" },
  { name: "Assoc. Prof. Dr. Mehmet Sarıkanat", title: "Ege University" },
  { name: "Assoc. Prof. Dr. Hülya Cebeci", title: "ITU Aviation" },
  { name: "Dr. Volkan Acar", title: "Atatürk University" },
  { name: "Dr. Alperen Doğru", title: "Ege University" },
  { name: "Prof. Dr. Funda Tıhmınlıoğlu", title: "Izmir Institute of Technology (IYTE)" },
  { name: "Assoc. Prof. Dr. Burcu Saner Okan", title: "Sabancı University" },
  { name: "Prof. Dr. Devrim Balköse", title: "Izmir Institute of Technoology (IYTE)" },
  { name: "Prof. Dr. Yusuf Menceloğlu", title: "Sabancı University" },
  ...
  { name: "Prof. Dr. Barış Çağlar", title: "Delft University, Aerospace Engineering" },
  { name: "Prof. Dr. Çağrı Ayrancı", title: "University of Alberta, Mechanical Engineering, Canada" },
  { name: "Prof. Dr. Steve Nutt", title: "University of Southern California, USA" },
  { name: "Prof. Dr. Holger Seitlitz", title: "Cottbus University, Mechanical Engineering, Germany" },
  { name: "Dr. Maya John", title: "Council for Scientific Research (CSIR), South Africa" },
  { name: "Prof. Dr. Ferrie Van Hattum", title: "Saxion University, Netherlands" },
  { name: "Prof. Dr. Kristiina Oksman", title: "Luleå Technical University, Sweden" },
  { name: "Prof. Dr. Dipa Roy", title: "University of Edinburgh, Scotland" },
  ...
  { name: "Prof. Dr. Mustafa Demir", title: "Izmir Institute of Technology (IYTE)" },
