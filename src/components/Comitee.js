...
export default function Committee() {
  ...
  const HonorBoard = [
    { "name": "Gürel Nişli, Prof. Dr.", "title": "Ege Üniversitesi, Kimya Mühendisleri Odası" },
...
const scientificAdvisoryCommittee = [
  ...
  { "name": "Devrim Balköse, Prof. Dr.", "title": "İzmir Yüksek Teknoloji Enstitüsü" },
  ...
  { "name": "Veli DENİZ, Prof.Dr.", "title": "Kimya Mühendisleri Odası" },
