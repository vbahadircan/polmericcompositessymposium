          ...
          <div className="p-6">
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li><strong>Regular Participant:</strong> To be announced</li>
                <li><strong>Student Participant:</strong> To be announced</li>
                <li><strong>Daily Participation:</strong> To be announced</li>
                <li><strong>Foreign Participants:</strong> To be announced</li>
              </ul>
