    ...
    return (
        <div className="bg-gray-100 min-h-screen py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl font-bold text-gray-900 mb-8 text-center">About İzmir</h1>

                <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                    <div className="p-6 space-y-6">
                        {/* Long Text Section */}
                        <p className="text-lg text-gray-700">
                            Izmir is a really special place to visit! Located in western Turkey on the shores of the Aegean Sea, it's the country's third-largest city. It's got an 8,500-year history, fertile lands, and 300 days of sunshine a year. It's been home to lots of different civilisations over the years, from the Persians to the Romans, and from the Byzantines to the Ottomans, which has made it a really vibrant place to visit. Nearly half of its four-million population is under the age of 30, which has created a lively, youthful atmosphere. The climate is perfect for growing grapes, figs, olives, and cotton, and the cuisine, with its olive oil, fresh seafood, wine, and local herbs, is a real treat for gourmets.
