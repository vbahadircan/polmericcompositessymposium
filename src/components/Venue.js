  ...
  return (
    <section className="mb-8">
      ...
      <p className="text-gray-700">
        The Tepekule Convention and Exhibition Centre is located in Izmir, Türkiye, offering state-of-the-art facilities for hosting international symposiums and workshops. It provides a professional setting ideal for fostering collaboration and innovation.
      </p>
    </section>
  )
}
